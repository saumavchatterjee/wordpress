...
define ('DIRECTORY_CACHE', './resources');		// cache directory
define ('MAX_WIDTH', 7700);					// maximum image width
define ('MAX_HEIGHT', 7700);				// maximum image height
define ('ALLOW_EXTERNAL', FALSE);			// allow external website (override security precaution - not advised!)
define ('MEMORY_LIMIT', '1024M');				// set PHP memory limit
define ('MAX_FILE_SIZE', 5242880);			// file size limit to prevent possible DOS attacks (roughly 1.5 megabytes)
