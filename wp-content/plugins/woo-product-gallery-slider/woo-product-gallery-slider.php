...
function wpgs_fs() {
    ...
    if ( ! isset( $wpgs_fs ) ) {
        ...
        if ( ! defined( 'WP_FS__PRODUCT_2886_MULTISITE' ) ) {
            define( 'WP_FS__PRODUCT_2886_MULTISITE', true );
        }

        // Include Freemius SDK.
        require_once dirname(__FILE__) . '/freemius/start.php';

        $wpgs_fs = fs_dynamic_init( array(
            'id'                  => '2886',
            'slug'                => 'woo-product-gallery-slider',
            'type'                => 'plugin',
            'public_key'          => 'pk_a0718389e069f0c012278a4d0be9d',
            'is_premium'          => false,
            'has_addons'          => false,
